...
///水印图片默认大小
#define KMaskImageWidth     (101.0f*1.8)
#define KMaskImageHeight    (37.5f*1.8)
...
#define waterMarkImage  @"ASWaterMark.png"
- (void)clickImageSave
{
...
//    [ITTMessageView showMessage:@"保存成功" disappearAfterTime:0.8];
...
//    NSData *imageData=[[NSData alloc]initWithContentsOfURL:[NSURL URLWithString:im.url]];
//    [self saveImageWithData:imageData];
...
//            [ITTMessageView showMessage:@"保存失败" disappearAfterTime:0.8];
        } else {
