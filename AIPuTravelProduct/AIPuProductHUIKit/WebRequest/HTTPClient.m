...
+ (HTTPClient *)sharedHTTPClientForSOneAPI{
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedHTTPClient = [[HTTPClient alloc] initWithBaseURL:[NSURL URLWithString:KSOneAPIURL]];
    });
    return _sharedHTTPClient;
}
...
+ (HTTPClient *)sharedHTTPClientForSynchronizeAPI{
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedHTTPClient = [[HTTPClient alloc] initWithBaseURL:[NSURL URLWithString:KSynchronizeAPIURL]];
    });
    return _sharedHTTPClient;
}
